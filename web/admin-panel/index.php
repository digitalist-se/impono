...
<html lang="en">
  ...
  <body>
                ...
                <div class="form-group">
                  <div dropdown id="top-user-menu" class="user-dropdown btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu user-dropdown-menu">
                      ...
                      <li id="user-menu-opt-out"><a ui-sref="optOutGenerator" class="user-menu-item"><i class="icon-optout"></i><span translate="Opt-out generator"></span></a></li>
    ...
    <div stg-set-version stg-version="0.0.8" ng-if="security.isAuthenticated()" class="stg-footer">
      <div class="container">
        <div ng-cloak class="row">
          <div class="col-md-6 col-md-offset-3 stg-standalone-text"><span translate="7tag version"></span> 0.0.8.</div>
        </div>
      </div>
    </div>
  ...
  <script type="text/ng-template" id="container-list-st-header.html ">
    <tr ng-if="$data.length &gt; 0">
      ...
      <th class="sortable"><span translate="Published"></span></th>
    </tr>
  </script>
